...
Product.delete_all
# . . .
Product.create(title: 'Black Coffee',
  description:
    %{<p>
        Coffee is a brewed beverage prepared from the roasted or baked seeds of several species of an evergreen shrub of the genus Coffea. The two most common sources of coffee beans are the highly regarded Coffea arabica, and the "robusta" form of the hardier Coffea canephora.
      </p>},
  image_url: 'http://upload.wikimedia.org/wikipedia/commons/4/45/A_small_cup_of_coffee.JPG',
  price: 12.99)
# . . .
